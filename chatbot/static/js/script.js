...
function handleLoanAgeSelection(age) {
  ...
  if (age === '0-20') {
    ...
    botMessage.innerHTML = `
      <div class="message-avatar">O</div>
      <div class="message-content">
        <p> OK, you are eligible for loan.<br>Do you have a skill/training certificate?</p>
        <div class="quick-replies" style="margin-top: 12px;">
...
function handleLoanCertSelection(cert) {
  ...
  if (cert === 'no') {
    displayMessage(
      'bot',
      ` Sorry, You are not eligible. Visit <a href="https://udyami.upicon.in/" target="_blank">UPICON e-Learnings</a> To Take Certification.`
    );
  } else if (cert === 'yes') {
    displayMessage(
      'bot',
      ' You are eligible for loan. Please contact my team for more information.'
    );
  }
}
